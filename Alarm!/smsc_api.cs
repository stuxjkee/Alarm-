// SMSC.UA API (smsc.ua) версия 2.9 (05.03.2015)
using System;
using System.Web;
using System.Net;
using System.IO;
...
public class SMSC
{
	...
	public static string SMSC_LOGIN = "";		    // логин клиента
    public static string SMSC_PASSWORD = "";	// пароль или MD5-хеш пароля в нижнем регистре
	...
	private string[] _smsc_send_cmd(string cmd, string arg, string[] files = null)
	{
		...
		string url = (SMSC_HTTPS ? "https" : "http") + "://smsc.ua/sys/" + cmd + ".php" + (SMSC_POST ? "" : "?" + arg);
